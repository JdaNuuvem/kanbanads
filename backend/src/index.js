...
const jsxOrder = ['icons.jsx','utils.jsx','api.jsx','login.jsx','users.jsx','workspace.jsx','social.jsx','data.jsx','card.jsx','creative.jsx','tabs.jsx','modal.jsx','views.jsx','app.jsx'];
...
app.get('/', (_req, res) => {
  try {
    ...
    // Build inline scripts in correct dependency order
    let inlineScripts = '';
